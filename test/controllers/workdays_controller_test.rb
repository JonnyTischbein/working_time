...
class WorkdaysControllerTest < ActionController::TestCase
  ...
  test "should create workday" do
    assert_difference('Workday.count') do
      post :create, workday: { comment: @workday.comment, end: @workday.end, start: @workday.start, type: @workday.type }
    end
  ...
  test "should update workday" do
    patch :update, id: @workday, workday: { comment: @workday.comment, end: @workday.end, start: @workday.start, type: @workday.type }
    assert_redirected_to workday_path(assigns(:workday))
  end
